async function newPlaceForm()
{
    const { value: formValues } = await Swal.fire({
        ...
        html:  `
        <form enctype="multipart/form-data" method="POST" action="./backendfiles/addplace.php?pid=2" class="Add-form">
...
async function EditPlaceForm(placeName,PlaceCost,PlaceDesc,H1,M1,H2,M2,Explore,city,id)
{
    ...
    const { value: formValues } = await Swal.fire({
        ...
        showConfirmButton: false ,
        html:  `
        <form enctype="multipart/form-data" method="POST" action="./backendfiles/updateplace.php?pid=2&id=${id}" class="Add-form"> 
        <label style = "display:flex"> <p style="width:25%; margin-top: revert;">Name</p>
          <div style="width:100%">
