        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td scope="col"><?php echo $h1 ?>:<?php echo $m2 ?></td>
              ...
              <td style="width:10%;"><button onclick='EditPlaceForm(<?php echo $PlaceName ; ?>, <?php  echo $PlaceCost; ?>, <?php  echo $Description; ?>, <?php  echo $h1; ?>, <?php  echo $m1; ?>, <?php echo $h2; ?>,<?php  echo $m2; ?>)'  class="btn btn-info btn-table"> <i style="color:white ;" class="fa-solid fa-pen"></i></button></td>
