    ...
    <div class="Dash-div">
     <div class="card text-center">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item ">
          <a class="nav-link dash-link active" href="./CulturalTours.php">Cultural</a>
        </li>
        <li class="nav-item">
      ...
      <div>
        <div class="search-city">
          ...
          <form method="POST" action="./CulturalTours.php" style="display:flex;  margin-left: 1%;width: 20%; justify-content: space-between;">
      ...
      <section >
            ...
            if(isset($_POST['city-selector']))
            {
              ...
              $query = "SELECT * FROM places WHERE location = '" .$_POST['city-selector'] . "' and type ='Cultural'";
              $result = mysqli_query($conn,$query);
              ?>
                <h4 class="search-title" style="color:black; font-size:20px"><?php echo $_POST['city-selector'] ?> Cultural city</h4>
            ...
            {
            ?>
             <h3 style="width:65%; margin-top: 30px; margin-right: auto; margin-left: auto;">From here you can search for a cultural place by city, choose a city and then click on the search button above</h3>
        <?php }
        if(isset($_POST['city-selector']))
        { ?>
            </div>
      ...
      <section>
        ...
        <button type="button" data-bs-target="#carouselExampleDark" data-bs-slide-to="0" class="active" aria-current="true" aria-label="Slide 1"></button>
          <?php 
              include "./backendfiles/conniction.php";
              $query = "SELECT * FROM places WHERE explore = 1 and type = 'Cultural'";
              $result = mysqli_query($conn , $query);
              $Arr = mysqli_fetch_all($result); 
              $counter1 = 0;
              $counter2 =1;
